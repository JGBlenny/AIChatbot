...
BEGIN
    ...
    -- 將新知識 ID 添加到 linked_knowledge_ids 數組
    UPDATE test_scenarios
    SET linked_knowledge_ids = array_append(
...
COMMENT ON FUNCTION approve_ai_knowledge_candidate IS '批准 AI 生成的知識候選，轉為正式知識庫內容（支援多意圖，寫入 knowledge_intent_mapping，已移除 category 欄位）';
