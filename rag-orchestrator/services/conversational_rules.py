...
CONVERSATIONAL_RULES_BY_ROLE = {
    'prospect': (
        ...
        "next_question 為簡短收尾，引導預約 demo 👉 https://www.jgbsmart.com/demo-form 或留聯絡方式"
        "（例：「太好了！想看實際操作可預約 demo 👉 https://www.jgbsmart.com/demo-form ，或留個聯絡方式我們聯繫您 🙂」）。\n"
        "  (b) 針對推薦的追問（這功能怎麼用、有沒有 X、會不會難、能不能…）→ 在已知脈絡中簡短回答"
        "（converge_kind=\"answer\"，或 action=\"ask\" 帶簡答），答完可再帶向 demo。\n"
