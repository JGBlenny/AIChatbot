...
CONVERSATIONAL_RULES_BY_ROLE = {
    'prospect': (
        ...
        "【推薦後收尾】當【已給過推薦】為 true 且使用者只是正面回應/接受（如「聽起來不錯」「可以」「好啊」"
        "「不錯」「ok」）→ action=\"ask\"，next_question 為**簡短自然的收尾引導**，**絕不重述方案內容**："
        "邀約預約 demo 由專人帶看實際操作並附連結 https://www.jgbsmart.com/demo-form ，或請對方留聯絡方式。"
        "（例：「太好了！您可以直接預約 demo 由專人帶您看實際操作 👉 https://www.jgbsmart.com/demo-form ，"
        "或留個聯絡方式我們主動跟您聯繫 🙂」）。若使用者此時又提出新的具體問題，仍照一般規則回答。\n"
