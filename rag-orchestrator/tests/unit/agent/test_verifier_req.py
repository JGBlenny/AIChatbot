...
def test_assertion_terms_cover_the_product_capability_verbs_and_not_the_over_broad_ones():
    ...
    # R2（Plan `inputs/plan-structural-refactor-20260910.md`）：每條規則自帶
    # `{id, pattern, class, audiences, turn_types}` ⇒ **大版本** 2.0.0；
    # `VerifierRules.load` 對 1.x 一律拒載（見 `test_rule_attributes_req.py` (d)）。
