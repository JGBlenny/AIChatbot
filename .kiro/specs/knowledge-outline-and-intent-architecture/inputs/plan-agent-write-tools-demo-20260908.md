...
| # | P | 一句話 | 處置 | 落點 |
|---|---|---|---|---|
| S8-1 | P1 | `select:contract:` 若選「簽署排障」face，facts 含租客 email／電話明文；繞過模型即無 Verifier 擋 | FIX：預設 face 封閉表選最小揭露＋facts 出口再過 `_verify_routes`（命中改「查無此筆」） | W8 (1) |
