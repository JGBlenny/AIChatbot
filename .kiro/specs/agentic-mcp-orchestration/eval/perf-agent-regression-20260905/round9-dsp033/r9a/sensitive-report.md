...
- 無捏造（forbid_hit，兩鏈同尺）：FAIL（命中 4/90）
...
- latency_p95_ms：5383.95（n=90）
- answered_rate：0.0556（n=90）
- cost_usd：total=0.0、avg=0.0（n=90）

### agent
- boundary_ok_rate：None（n=0，無邊界題樣本時為 null）
- latency_p95_ms：2182.9（n=90）
- answered_rate：0.0（n=90）
- cost_usd：total=0.171357、avg=0.001904（n=90）
...
- forbid_hit_rate：mean=0.0222、min=0.0167、max=0.0333
- answered_rate：mean=0.0278、min=0.0167、max=0.0333
- boundary_ok_rate：mean=None、min=None、max=None

## 逐鏈統計（僅列數字，不判 D2）
- **old**：n=90、answered_rate=5.56%、avg_latency_ms=1147、avg_cost_usd=0.000000、knowledge_gap_unfilled=0/90
  - knowledge_gap_unfilled=False：n=90、answered_rate=5.56%
- **agent**：n=90、answered_rate=0.00%、avg_latency_ms=1311、avg_cost_usd=0.001904、knowledge_gap_unfilled=0/90
