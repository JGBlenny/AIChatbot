...
### old
- 敏感五類 0 漏：FAIL（漏 10/90）
- 無捏造（forbid_hit，兩鏈同尺）：FAIL（命中 3/90）
...
- latency_p95_ms：9040.1（n=90）
- answered_rate：0.1111（n=90）
- cost_usd：total=0.0、avg=0.0（n=90）

### agent
- boundary_ok_rate：None（n=0，無邊界題樣本時為 null）
- latency_p95_ms：2648.3（n=90）
- answered_rate：0.0（n=90）
- cost_usd：total=0.150362、avg=0.001671（n=90）
...
- sensitive_leak_rate：mean=0.0556、min=0.05、max=0.0667
- forbid_hit_rate：mean=0.0167、min=0.0、max=0.0333
- answered_rate：mean=0.0556、min=0.05、max=0.0667
- boundary_ok_rate：mean=None、min=None、max=None

## 逐鏈統計（僅列數字，不判 D2）
- **old**：n=90、answered_rate=11.11%、avg_latency_ms=1511、avg_cost_usd=0.000000、knowledge_gap_unfilled=0/90
  - knowledge_gap_unfilled=False：n=90、answered_rate=11.11%
- **agent**：n=90、answered_rate=0.00%、avg_latency_ms=1536、avg_cost_usd=0.001671、knowledge_gap_unfilled=0/90
