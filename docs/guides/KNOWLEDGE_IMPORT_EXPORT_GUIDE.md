...
| id | question_summary | answer | scope | vendor_id |
|----|-----------------|--------|-------|-----------|
| | 如何報修水管？ | 請聯繫... | vendor | 2 |
| | 如何更換門鎖？ | 更換門鎖... | vendor | 2 |
...
```excel
id    | question_summary | answer                  | scope  | vendor_id | priority
------|-----------------|-------------------------|--------|-----------|----------
5011  | 如何繳租金？     | 租金繳納方式有...        | vendor | 2         | 1
      | 如何報修？       | 請聯繫客服...            | global |           | 0
```
...
5. **vendor_id 隔離**
   - 匯入時指定 `vendor_id` 會自動設定 `scope=vendor`
   - 不同業者的知識會自動隔離
