...
|------|-----------------|-----------------|-----------------|
| **觸發模式** | manual（等關鍵詞） | auto（自動觸發） | immediate（立即詢問） |
...
💭 系統內部處理：
   [20:15:22] SOP 內容已返回
   [20:15:22] trigger_mode = 'none'，無後續動作
...
💭 系統內部處理：
   ...
   [10:30:48] 檢索垃圾 SOP（trigger_mode: 'none'）
