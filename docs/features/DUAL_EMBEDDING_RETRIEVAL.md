...
> **⚠️ 重要更新**: 此方案後續發現 Primary Embedding 存在稀釋問題，已透過 Primary Embedding 修復 進一步優化，最終涵蓋率達到 **92.6%**。本文檔記錄初始雙重檢索機制的實施過程。
...
- VENDOR_SOP_RETRIEVAL_IMPROVEMENT.md - Intent 改為輔助
