...
| 文件 | 說明 | 狀態 |
|------|------|------|
| INTENT_MANAGEMENT_README.md | Intent 意圖管理系統 | ✅ |
| MULTI_INTENT_CLASSIFICATION.md | 多意圖分類功能 | ✅ |
| MULTI_INTENT_SCORING.md | 多意圖評分機制 | ✅ |
| AI_KNOWLEDGE_GENERATION_FEATURE.md | AI 自動知識生成 | ✅ |
| INTENT_SUGGESTION_SEMANTIC_DEDUP_IMPLEMENTATION.md | Intent 建議語意去重 | ✅ |
| SOP_Group_Embedding_Optimization.md | SOP 分組 Embedding 優化 | ✅ |

### 📚 知識庫管理 (9 個)

| 文件 | 說明 | 狀態 |
|------|------|------|
| KNOWLEDGE_IMPORT_FEATURE.md | 知識匯入功能 | ✅ |
| MULTI_FILE_IMPORT.md | 多檔案批次匯入 | ✅ |
| LINE_CHAT_IMPORT_FINAL_SUMMARY.md | LINE 對話匯入（完整優化） | ✅ |
| [DOCUMENT_CONVERTER.md](./DOCUMENT_CONVERTER.md) | 文件轉換功能（Word/PDF → Q&A） | ✅ |
| PRIORITY_SYSTEM.md | 知識優先級系統 | ✅ |
...
| PRIMARY_EMBEDDING_FIX.md | Primary Embedding 稀釋修復 ⭐⭐⭐ 最新 | ✅ |
...
| FORM_GUIDANCE_IMPROVEMENT_2026-01-13.md | 表單引導改善 | ✅ |
...
| DUPLICATE_TEST_SCENARIO_PREVENTION.md | 重複測試情境防止 | ✅ |
| REJECTED_SCENARIO_RETRY_IMPLEMENTATION.md | 被拒情境重試機制 | ✅ |
...
| B2B_API_INTEGRATION.md | B2B API 整合 | ✅ |
...
1. **INTENT_MANAGEMENT_README.md** - 理解 Intent 系統架構
2. **MULTI_INTENT_CLASSIFICATION.md** - 多意圖分類實作
...
2. **LINE_CHAT_IMPORT_FINAL_SUMMARY.md** - 從 LINE 對話匯入知識
3. **KNOWLEDGE_IMPORT_FEATURE.md** - Excel/JSON 批次匯入
4. **PRIORITY_SYSTEM.md** - 設定知識優先級
...
**技術改進 3**: PRIMARY_EMBEDDING_FIX.md ⭐⭐⭐ 最新
...
**文件**: LINE_CHAT_IMPORT_FINAL_SUMMARY.md
...
**主文件**: MULTI_INTENT_CLASSIFICATION.md
...
**文件**: INTENT_MANAGEMENT_README.md
